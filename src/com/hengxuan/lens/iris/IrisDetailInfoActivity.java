...
public class IrisDetailInfoActivity extends Activity {
						...
						try {
							...
							addtoReportBtn.setOnClickListener(new OnClickListener() {
								...
								public void onClick(View v) {
									...
									// TODO Auto-generated method stub
									int getCurIndex = ContextUtils.getIntFromPreferences(IrisDetailInfoActivity.this, "currentIndex", 0);
									SimpleDateFormat format = new SimpleDateFormat("yyyy-MM-dd");
									Date currentdate = new Date(System.currentTimeMillis());
									String timestr = format.format(currentdate);
									if(getCurIndex != -1){
										String getUserPin = ContextUtils.getStringFromPrefences(IrisDetailInfoActivity.this, ConstHttpProp.USER_PIN);
