...
public class HairAnalysisResultActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		addtoReportBtn.setOnClickListener(new OnClickListener(){
			...
			public void onClick(View v) {
				...
				String getUserPin = PreferencesUtils.getStringFromPreferences(HairAnalysisResultActivity.this, "eht", ConstHttpProp.USER_PIN, "");
